...
---
## Updates
- **[2026/04/13]** **EfficientSAM3.1** and **SAM3.1-LiteText** image models were released on the [`stage1_sam3.1`](https://github.com/SimonZeng7108/efficientsam3/tree/data_engine) branch. SAM3-LiteText has also been officially merged into [Hugging Face Transformers](https://github.com/huggingface/transformers/pull/44320). Stage 3 data engine support is now available on the [`data_engine`](https://github.com/SimonZeng7108/efficientsam3/tree/data_engine/data_engine) branch.
